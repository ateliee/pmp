...
class Define
{
    static $MOBILE_DOCOMO = 'DOCOMO';
    static $MOBILE_AU = 'AU';
    static $MOBILE_SOFTBANK = 'SOFTBANK';
    static $MOBILE_WILLCOM = 'WILLCOM';
    /**
     * DOCOMO(携帯IPアドレス帯)
     *
     * @var array
    ...
    {
        $arr = array();
        $arr[self::$MOBILE_DOCOMO] = self::$CIDR_DOCOMO;
        $arr[self::$MOBILE_AU] = self::$CIDR_AU;
        $arr[self::$MOBILE_SOFTBANK] = self::$CIDR_SOFTBANK;
        return $arr;
    }
    ...
    static public function getDomainAll(){
        $arr = array();
        $arr[self::$MOBILE_DOCOMO] = self::$DOMAIN_DOCOMO;
        $arr[self::$MOBILE_AU] = self::$DOMAIN_AU;
        $arr[self::$MOBILE_SOFTBANK] = self::$DOMAIN_SOFTBANK;
        $arr[self::$MOBILE_WILLCOM] = self::$DOMAIN_WILLCOM;
        return $arr;
    }
